...
public class Align2TextView extends TextView {
    ...
    private AlignTextView.Align align     = AlignTextView.Align.ALIGN_LEFT; // 默认最后一行左对齐
    ...
    public Align2TextView(Context context) {
        super(context);
        setTextIsSelectable(false);
    }

    public Align2TextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setTextIsSelectable(false);
        ...
        switch (alignStyle) {
            case 1:
                align = AlignTextView.Align.ALIGN_CENTER;
                break;
            case 2:
                align = AlignTextView.Align.ALIGN_RIGHT;
                break;
            default:
                align = AlignTextView.Align.ALIGN_LEFT;
                break;
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < lines.size(); i++) {
            ...
            if (tailLines.contains(i)) {
                interval = 0;
                if (align == AlignTextView.Align.ALIGN_CENTER) {
                    drawSpacingX += gap / 2;
                } else if (align == AlignTextView.Align.ALIGN_RIGHT) {
                    drawSpacingX += gap;
                }
            }
     ...
     * @param align 对齐方式
     */
    public void setAlign(AlignTextView.Align align) {
        this.align = align;
        invalidate();
    }
