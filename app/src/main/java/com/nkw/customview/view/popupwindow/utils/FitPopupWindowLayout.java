...
public class FitPopupWindowLayout extends RelativeLayout {
    ...
    public static  int SHARP_WIDTH = 50;
    public static  int SHARP_HEIGHT = (int) (SHARP_WIDTH * 0.5f);
    ...
    private Path makeSharpPath() {
        ...
        mSharpPath.cubicTo(mXoffset, getMeasuredHeight(), mXoffset, getMeasuredHeight() - SHARP_HEIGHT,
         ...
         //修改
        mSharpPath.moveTo(mXoffset,getMeasuredHeight() - SHARP_HEIGHT);
        mSharpPath.lineTo(mXoffset+SHARP_WIDTH/2,getMeasuredHeight());
        mSharpPath.lineTo(mXoffset + SHARP_WIDTH,getMeasuredHeight()-SHARP_HEIGHT);
        return mSharpPath;
    }
